...
public class Main {
	...
	public static void main(String[] args) {
		...
		AbstractSwappingSortingAlgorithm<MarkedValue<Integer>> algorithm = new ShakerSort<MarkedValue<Integer>>(markedComparator);
		
		testing.results.swapping.Result result = Tester.runNTimes(algorithm, generator, 20000, 20);
